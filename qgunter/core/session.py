"""Gestión de sesiones — guardar y restaurar estado de ejecuciones.

Las sesiones se guardan como ficheros JSON en ~/.qgunter/sessions/.
Esto permite parar Q-Gunter, cerrar todo, y retomarlo días después.
"""
...
class SessionStore:
    """Almacén de sesiones basado en ficheros JSON."""

    SESSIONS_DIR = Path.home() / ".qgunter" / "sessions"
    ...
    # === Métodos para actualizar la sesión activa ===
